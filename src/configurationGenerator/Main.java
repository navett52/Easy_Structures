...
public class Main extends Application
{
	...
	public void OnClick(ActionEvent evt) 
	{
		...
		YMLgenerator yml = new YMLgenerator(nameOfFile, placeToSpawn, maxNumOfSpawns, spawnChance, depthOfbasement, minimumHeight, maximumHeight, randomRotate, pasteSchematicAir);
