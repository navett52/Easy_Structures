...
//////////////////////////////Getting the biome schematics///////////////////////////////////////////
    ...
    /**
     * Scans chunk for naturally spawned doors to identify villages
     * To be used with the NoDefaultTrees method
     * @author Connor
    ...
    {		
    	...
    	//starts a series of loops to systematically go through all of the blocks in the the chunk
		for(int x = 16; x >= 0; x--)
		{
			for(int z = 16; z >= 0; z--)
			{
				for(int y = 255; y >= 0; y--)
				{
					//checks a block at the coordinates x,y,z and gets their material
					Material material = loadBlockInChunk(x, y, z).getType();
					...
					else if(material == Material.DIRT || material == Material.GRASS || material == Material.STONE ||
							material == Material.SAND || material == Material.WATER || material == Material.CLAY ||
		...
		//returns door existence
    	return doorExistence;
    }
}
