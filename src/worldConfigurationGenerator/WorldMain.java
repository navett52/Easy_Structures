package worldConfigurationGenerator;

import worldConfigurationGenerator.WorldMain;
import worldConfigurationGenerator.YMLGenerator;
...
public class WorldMain extends Application
{
	...
	public void start(Stage primaryStage) throws Exception
	{
		...
		try {
			...
			loader.setLocation(WorldMain.class.getResource("/worldConfigurationGenerator/WorldConfigurationGeneratorScene.fxml"));
